...
# Tell Vivado about the 50 MHz generated clock
create_generated_clock -name slow_clk_gen -source [get_ports clk] -divide_by 2 [get_pins clk_div_reg/Q]
...
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { tx_serial }]; #IO_L11N_T1_SRCC_35 Sch=uart_rxd_out
